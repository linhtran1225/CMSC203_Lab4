    ...
    // Write your code here:
	   ...
	   for (int i = 0; i < intArray.length; i++) {
		   if (minValue > intArray[i][column]) {
			   minValue = intArray[i][column];
		   }
		   animate(i, column, minValue);
	   }
	   System.out.println("Minimum of column " + column + " = "+ minValue);
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   ...
	   System.out.print("Number of times value " + value + " occured is " + count);
